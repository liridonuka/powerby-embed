...
export class Clock extends React.Component<IClockProps, IClockState> {
  ...
  private getDateTimeWithOffset(): Date {
    ...
    const isDST: boolean =
      ...
      Math.max(
        withoutDSTDate.getTimezoneOffset(),
        withDSTDate.getTimezoneOffset()
      );
    ...
    const dateTimeWithOffset: Date = new Date(
      utcNow.getTime() +
